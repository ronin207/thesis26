...
path; the other two demonstrate that the interface generalizes and, by the
criterion, do not pay, because the host's $256$-bit modular-multiplication
precompile already serves their arithmetic.
