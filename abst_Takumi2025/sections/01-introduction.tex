...
hash (Griffin), which makes up $\approx 91\%$ of the verification's R1CS
constraints at PLUM-128, amplifies the penalty. This thesis asks whether such a verification can be
