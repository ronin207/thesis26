...
zero-knowledge wrap's memory exhaustion and the SHA-3 control's faster
...
\begin{tikzpicture}[
  ...
  \node[t, below left=12mm and -10mm of wrap] (oom) {\includegraphics[height=8mm]{figs/assets/memory.png}\\ \textbf{OOM} ${\approx}20$\,GB / $24$\,GB};
