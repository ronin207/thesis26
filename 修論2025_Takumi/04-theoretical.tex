...
established analytically (Proposition~\ref{prop:field-match}), postdictively (the
mismatched arm), and empirically on the matched side; the prove-mode corollary,
