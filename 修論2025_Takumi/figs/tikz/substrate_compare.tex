...
% lambda=80); zkVM PLUM-verify 32.5 min with precompile (Cell 2). Update churn:
...
\node[vm,below=3mm of vc,fill=orange!24] (vd) {receipt\\\scriptsize $32.5$\,min (PLUM verify)};
