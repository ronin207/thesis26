...
Un-precompiled, a large-field operation does not complete; a syscall routes it to a
native chip, whose cost is charged host-side---so a guest-cycle saving need not be
a wall-clock one.}
